""" app.py ------ Flask REST API — Portfolio AI Backend Compatible with Windows / Python 3.12 """
import os
import sys
import socket
...
def api_grammar():
    """
    Request:
    { "text": "i am a passionat softare enginr" }

    Response:
    { "original": "...", "corrected": "...", "changed": true }
    """
...
def api_autocomplete():
    """
    Request:
    { "text": "I am a passionate", "top_k": 5, "num_words": 5 }

    Response:
    { "seed": "...", "completions": [...], "ready": true }
    """
    if request.method == "OPTIONS":
        return jsonify({}), 200
...
def api_rewrite():
    """
    Request:
    { "text": "i worked on building a website", "field": "experience" }

    Response:
    { "original": "...", "rewritten": "...", "changed": true, "hint": "..." }
